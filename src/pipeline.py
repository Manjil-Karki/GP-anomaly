...
def phase6_evaluation(
    ...
    for method in ("gp", "knn", "maha", "fused", "gpclf", "proto", "fused2", "fused3", "fused5"):
    ...
    for candidate in ("fused3", "fused2", "fused5", "fused", "gp"):
    ...
    for m in ("gp", "knn", "maha", "gpclf", "proto", "fused", "fused2", "fused3", "fused5"):
